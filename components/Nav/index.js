	...
	return (
        ...
        <nav className="Nav">
            <div className="Nav__container">
                <a href="#0" className={'Nav__container__item ' + (router.pathname == '/tasks' ? 'Nav__container__item--active' : '')}>
                ...
                <a href="#0" className={'Nav__container__item ' + (router.pathname == '/' ? 'Nav__container__item--active' : '')}>
                    <div className="Nav__container__item__icon">
                        <MenuIcon></MenuIcon>
                    </div>
                    <div className="Nav__container__item__icon--fill">
                ...
                <a href="#0" className={'Nav__container__item ' + (router.pathname == '/piggy-bank' ? 'Nav__container__item--active' : '')}>
                     <div className="Nav__container__item__icon">
