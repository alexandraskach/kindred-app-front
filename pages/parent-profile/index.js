...
export default function render() {
  ...
  return (
    <Base>
      <div id={styles.ParentProfile} className="mt-8">
        <div className={styles.container__profile}>
          <div>
            <div className={styles.profile__picture}>
              <span>{Array.from(data.first_name)[0]}</span>
            </div>
            <div className={styles.profile__name}>Robert godwin</div>
            <div className={styles.profile__status}>Parent</div>
          </div>
