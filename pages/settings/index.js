			...
			<div id={styles.ParentProfile}>
				...
				<div className="Card">
					...
					{data.children.map((child) => (
						<div className={styles.profile__child} key={child.id}>
							<div className={styles.profile__child__picture}></div>
							<div className={styles.profile__informations}>
								<a className={styles.profile__child__name} href="/parent-contract">{child.first_name} {child.last_name}</a>
								<div className={styles.profile__contract__date}>{child.contract_date}</div>
							</div>
				...
				<div className="Card">
					...
					<div className={styles.profile__informations}>
						...
						<div className={styles.profile__birthdate}>Born on the {data.birthdate}</div>
					</div>
				</div>

				{/* affichage des infos personelles */}
				<div className="Card">
					<input className="Button Button--tertiary" type="button" value={"logout"} />
